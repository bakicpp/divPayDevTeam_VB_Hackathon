...
class Card3Page extends StatefulWidget {
  const Card3Page({super.key});

  @override
  State<Card3Page> createState() => _Card3PageState();
}

class _Card3PageState extends State<Card3Page> {
  @override
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
              ...
              colors: [Color(0xff717171), Color(0xffC2C2C2)])),
