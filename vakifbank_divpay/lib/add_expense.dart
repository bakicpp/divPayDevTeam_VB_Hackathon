...
import 'package:vakifbank_divpay/fis_loading.dart';
...
final snackBar = SnackBar(content: Text('Yummy snackbar'));
...
class _AddExpenseState extends State<AddExpense> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomSheet: Padding(
          ...
          child: fisEkle(pageWidth, pageHeight, context),
        ),
        appBar: AppBar(
                            ...
                            GestureDetector(
                              onTap: () {
                                final snackBar = SnackBar(
                                    content: const Text('Harcama eklendi.'),
  ...
  ElevatedButton fisEkle(
      double pageWidth, double pageHeight, BuildContext context) {
    return ElevatedButton(
      onPressed: () {
        onImageButtonPressed(ImageSource.gallery);
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const FisLoad()),
        );
      },
      child: Text(
        "FİŞ EKLE",
